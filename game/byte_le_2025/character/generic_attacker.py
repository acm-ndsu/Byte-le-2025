...
class GenericAttacker(Character):
    def __init__(self, name: str = '', character_type: CharacterType = CharacterType.ATTACKER, health: int = 1, attack: int = 1, defense: int = 1,
        ...
        self.object_type = ObjectType.GENERIC_ATTACKER
        self.character_type = CharacterType.ATTACKER
