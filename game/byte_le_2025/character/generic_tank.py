...
class GenericTank(Character):
    def __init__(self, name: str = '', character_type: CharacterType = CharacterType.TANK, health: int = 1, attack: int = 1, defense: int = 1,
        ...
        self.object_type = ObjectType.GENERIC_TANK
        self.character_type = CharacterType.TANK
