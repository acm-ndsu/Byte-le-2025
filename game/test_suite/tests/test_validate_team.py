...
from game.commander_clash.character.character import Generic, Leader, GenericAttacker, GenericTrash
...
class TestValidateTeam(unittest.TestCase):
    ...
    def test_invalid_team(self) -> None:
        ...
        self.assertTrue(all([isinstance(character, GenericTrash) for character in validate(self.invalid_team)]))
    ...
    def test_team_of_one_character_type(self) -> None:
        ...
        self.valid_team: tuple[SelectLeader, SelectGeneric, SelectGeneric] = (SelectLeader.FULTRA,
                                                                              SelectGeneric.GEN_ATTACKER,
                                                                              SelectGeneric.GEN_ATTACKER)
        ...
        self.assertTrue(isinstance(result[0], GenericTrash))
        self.assertTrue(isinstance(result[1], GenericAttacker))
        self.assertTrue(isinstance(result[2], GenericAttacker))
